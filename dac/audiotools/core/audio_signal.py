...
# NOTE(riffallen): rm julius dependency because we don't need for dac inference
# import julius
import numpy as np
import soundfile
import torch
...
# NOTE(riffallen): removed all the "mixins" that are unnecessary for our use case
class AudioSignal(
    EffectMixin,
    LoudnessMixin,
    # PlayMixin,
    ...
    def resample(self, sample_rate: int):
        ...
        # NOTE(allen): this func is not needed for inference
        # (and has julius dependency, which we want to remove)
